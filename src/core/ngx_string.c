        ...
        if (*fmt == '%') {
            ...
            case 'f':
                ...
                if (frac_width) {
                    ...
                    buf = ngx_springf_num(buf, last, frac, '0', 0, frac_width);
                }
...
ngx_sprintf_num(u_char *buf, u_char *last, uint64_t ui64, u_char zero,
    ngx_uint_t hexdecimal, ngx_uint_t width)
{
    ...
    if (hexdecimal == 0) {
        ...
        if (ui64 <= (uint64_t) NGX_MAX_UINT32_VALUE) {
            ...
            /*
             * To devide 64-bit numbers and to find remainders
             * on the x86 platform gcc and icc call the libc functions
             * [u]divdi3() and [u]moddi3(), they call another function
             * in ites turn.  On FreeBSD it is the qdivrem() function,
             * its source code is about 170 lines of the code.
             * The glibc counterpart is about 150 lines of code.
             *
 ...
 * substring with known length in null-teminated string. The argument n
...
ngx_strcasestrn(u_char *s1, char *s2, size_t n)
{
    ...
    } while (ngx_strcasencmp(s1, (u_char *) s2, n) != 0);
